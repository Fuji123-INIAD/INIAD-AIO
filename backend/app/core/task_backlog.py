...
def pending_task_item(item: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "source": nullable_text(item.get("source")),
        "source_kind": nullable_text(item.get("source_kind")),
        "confidence": nullable_text(item.get("confidence")),
        "status": nullable_text(item.get("status")) or "unknown",
        "active": bool(item.get("active", True)),
        "kind": first_text(item.get("kind"), item.get("resource_kind")) or "assignment",
        ...
        "submission_format_text": first_text(item.get("submission_format_text")) or "unknown",
        "submission_format_confidence": first_text(item.get("submission_format_confidence")) or "unknown",
